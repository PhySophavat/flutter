    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 1,
          title: Text('Our Menu', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
          centerTitle: false,
          bottom: TabBar(
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => ProductDetailScreen(
                                  name: item["name"]!,
                                  weight: '', // Placeholder, not in menuItems
                                  price: item["price"]!,
                                  image: item["image"]!,
                                  description: 'A delicious ${item["name"]} made with fresh ingredients.',
                                ),
                              ),
                            );
                          },
