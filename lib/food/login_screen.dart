...
ClipRRect(
  ...
  child: Image.asset(
    'images/img.png',
    height: 160,
    fit: BoxFit.cover, // Optional: ensures the image covers the area
  ),
),
                ...
                const Row(
                  ...
                  children: [
                    ...
                    Text("Signup", style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
                  ],
                ),
                const SizedBox(height: 20),
                const Row(
      ...
      child: ElevatedButton(
        ...
        child: Row(
          children: [
            ...
            Expanded(child: Text(label, style: const TextStyle(fontSize: 14, color: Color(0xFF333333)))),
          ],
        ),
      ),
    );
